...
def setup_output_directories():
    word_dir = os.path.join("Associate_Degree_word_files")
    pdf_dir = os.path.join("Associate_Degree_pdf_files")
...
# Usage
generate_certificates("Data.xlsx", "Certificate_degree.docx")
